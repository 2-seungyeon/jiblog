      ...
      ? [
          {
            name: "authenticated",
            testMatch:
              /step3[89](?:\.[567])?-authenticated-qa\.spec\.ts|step40-authenticated-qa\.spec\.ts|step42-authenticated-qa\.spec\.ts|step43-authenticated-qa\.spec\.ts|step45-authenticated-qa\.spec\.ts|step46-authenticated-qa\.spec\.ts|step39z-logout\.spec\.ts/,
            dependencies: ["setup"],
            fullyParallel: false,
            use: {
              ...devices["Desktop Chrome"],
